...
| `tls`             | null or submodule        | `null`                  | serve vhosts over TLS with an http→https redirect; `null` = plain http |
...
| `listenAddresses` | list of str              | nginx's                 | `services.nginx.defaultListenAddresses`; set when other vhosts bind specific addresses |
